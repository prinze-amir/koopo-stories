...
class Koopo_Stories_Share
{
    ...
    public static function activity_share_button()
    {
        ...
        // Render a simple button/icon for the meta area
        printf(
            '<a href="#" class="button koopo-share-to-story bp-secondary-action" data-img="auto" data-link="%s" data-title="%s" title="%s" style="margin-left:5px;"><span class="dashicons dashicons-share" style="vertical-align:middle;margin-right:5px;"></span>%s</a>',
            esc_url($link),
            esc_attr('Shared Activity'),
            esc_attr__('Share to Story', 'koopo'),
            esc_html__('Share to Story', 'koopo')
        );
    }
    ...
    public static function add_activity_bubble_button($buttons, $activity_id)
    {
        ...
        $buttons['koopo_share_to_story'] = [
            ...
            'button_attr' => [
                'type' => 'button',
                'class' => 'button koopo-share-to-story bp-secondary-action',
                'title' => __('Share to Story', 'koopo'),
                'data-img' => 'auto',
                'data-link' => $link,
                'data-title' => 'Shared Activity',
            ...
            'link_text' => sprintf(
                '<span class="dashicons dashicons-share" aria-hidden="true" style="vertical-align:middle;margin-right:5px;"></span><span class="share-label">%s</span>',
                esc_html__('Share to Story', 'koopo')
            ),
        ];
    ...
    public static function add_activity_entry_button($buttons, $activity_id)
    {
        ...
        $buttons['koopo_share_to_story'] = [
            ...
            'link_title' => esc_html__('Share to Story', 'koopo'),
            'link_class' => 'button bp-secondary-action koopo-share-to-story',
    ...
    public static function register_scripts()
    {
        wp_register_script(
            ...
            defined('KOOPO_STORIES_VER') ? KOOPO_STORIES_VER : '1.0.0',
            true
        );
    }
    ...
    public static function append_share_button($content)
    {
        ...
        $btn = sprintf(
            '<div class="koopo-share-wrapper" style="margin-top: 20px; margin-bottom: 20px;">
                <button type="button" class="koopo-share-to-story button" data-img="%s" data-link="%s" data-title="%s" data-type="%s">
                    <span class="dashicons dashicons-share" style="vertical-align:middle;margin-right:5px;"></span> %s
                </button>
            </div>',
            esc_url($img_url),
            esc_url($link),
