...
final class Koopo_Stories_Module
{
    ...
    public function init(): void
    {
        ...
        require_once KOOPO_STORIES_PATH . 'includes/stories/class-stories-share.php'; // New Share Class
        ...
        require_once KOOPO_STORIES_PATH . 'includes/stories/class-stories-profile.php';
        Koopo_Stories_Profile::init();
    ...
    public function shortcode_widget($atts = []): string
    {
        if (!is_user_logged_in())
            return '';
        if (get_option(self::OPTION_ENABLE, '1') !== '1')
            return '';
        ...
        if ($layout === 'vertical')
            $classes .= ' koopo-stories--vertical';
