...
final class Koopo_Stories_Module {
    ...
    public function init() : void {
        ...
        require_once KOOPO_STORIES_PATH . 'includes/class-stories-cpt.php';
        ...
        require_once KOOPO_STORIES_PATH . 'includes/class-stories-close-friends-ui.php';
        ...
        require_once KOOPO_STORIES_PATH . 'includes/class-stories-permissions.php';
        require_once KOOPO_STORIES_PATH . 'includes/class-stories-rest.php';
        require_once KOOPO_STORIES_PATH . 'includes/class-stories-cleanup.php';
        require_once KOOPO_STORIES_PATH . 'includes/class-stories-widget.php';
        require_once KOOPO_STORIES_PATH . 'includes/class-stories-admin.php';
